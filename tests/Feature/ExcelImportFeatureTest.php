...
class ExcelImportFeatureTest extends TestCase
{
    ...
    public function admin_can_import_questions_from_excel()
    {
        ...
        $response = $this->actingAs($admin)->post(route('admin.admin.placement-tests.import-questions', $placementTest), [
            'excel_file' => $file
        ]);
    ...
    public function student_cannot_access_import_functionality()
    {
        ...
        $response = $this->actingAs($student)->post(route('admin.admin.placement-tests.import-questions', $placementTest), [
            'excel_file' => $file
        ]);
