            ...
            <nav class="bg-white border-b border-gray-200">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                @auth
                                    @if(auth()->user()->isAdmin())
                                        <x-nav-link :href="route('admin.view')" :active="request()->routeIs('admin.*')">
                                            {{ __('View as Admin') }}
                                        </x-nav-link>
                                    @endif
                                @endauth
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            @auth
                                <div class="relative">
                                    ...
                                    <div id="user-dropdown-menu" class="absolute z-50 mt-2 w-48 rounded-md shadow-lg origin-top-right right-0 hidden">
                            ...
                            @else
                                <div class="hidden sm:flex sm:items-center sm:ms-6">
                                    ...
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="text-gray-500 hover:text-gray-700 ml-4 px-3 py-2 text-sm font-medium">Register</a>
                                    @endif
                                </div>
                            @endauth
                        </div>
                ...
                <div id="mobile-menu" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        @auth
                            @if(auth()->user()->isAdmin())
                                <x-responsive-nav-link :href="route('admin.view')" :active="request()->routeIs('admin.*')">
                                    {{ __('View as Admin') }}
                                </x-responsive-nav-link>
                            @endif
                        @endauth
