<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Recent Quiz Attempts and Recommended Courses -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Rekomendasi Berikutnya</h3>
                        @if($recommendedCourses->count() > 0)
                            <div class="space-y-3">
                                @foreach($recommendedCourses as $course)
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        <div class="p-3">
                                            <h4 class="text-md font-medium text-gray-800 mb-1">{{ $course->title }}</h4>
                                            <p class="text-xs text-gray-500 mb-2">{{ str($course->description)->limit(80) }}</p>
                                            <div class="flex justify-between items-center text-xs text-gray-500 mb-2">
                                                <span>{{ $course->lessons_count }} lessons</span>
                                            </div>
                                            <a href="{{ route('courses.show', $course->slug) }}" class="inline-flex items-center px-2 py-1 border border-transparent text-xs leading-4 font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                                Start Learning
                                            </a>
                                        </div>
                                    </div>
                        ...
                        @else
                            <div class="text-center py-4">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">No recommended courses</h3>
